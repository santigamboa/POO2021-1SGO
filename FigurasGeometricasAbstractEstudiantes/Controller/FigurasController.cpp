...
void FigurasController::setDummyFiguras(){
    ...
    listaFiguras.push_back( miCirculo );
    listaFiguras.push_back( miRectangulo );
    listaFiguras.push_back( miTriangulo );
    listaFiguras.push_back( miCuadrado );
}